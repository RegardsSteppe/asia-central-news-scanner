...
ACTIVIST_TERMS = [
    ...
    # Formes féminines — repéré en audit réel le 2026-09-11 : le
    # féminin de "правозащитник" change la fin du radical (-ник ->
    # -ница), donc ne matche jamais via une simple recherche de
    # phrase du masculin, contrairement à активист->активистка.
    "активистка",
    "активистки",
    "активисток",
    "правозащитница",
...
ACTIVIST_REPRESSION_RU_PATTERNS = [
    ...
    # "правозащитниЦА" (féminin) : contrairement à активист->активистКА
    # ou журналист->журналистКА (simple suffixe ajouté au masculin),
    # le féminin de "правозащитник" change la fin du radical
    # (-ник -> -ниц), donc n'est pas capturé par une substring du
    # masculin — repéré en audit réel le 2026-09-11 sur une défenseure
    # des droits condamnée, jamais reconnue comme cible.
    r"(?:правозащитник|правозащитниц).{0,120}(задержан|арестован|осужден|заключен|преследуется|обвинен)",
...
JOURNALIST_REPRESSION_RU_PATTERNS = [
    ...
    r"корреспондент.{0,100}(задержан|арестован|осужден|заключен|обвинен|преследуется)",
